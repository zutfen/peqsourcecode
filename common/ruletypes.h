...
RULE_REAL(Pets, PetPowerLevelCap, 40, "Maximum number of levels a player pet can go up with pet power")
...
RULE_BOOL(Pets, AutoSuspendOnDeath, false, "If true, the server auto-suspends the player's pet on death and auto-restores it on respawn.")
RULE_BOOL(Pets, UsePetGearBag, false, "Enable pet gear bag system")
RULE_INT(Pets, PetGearBagLoregroup, 0, "LoreGroup ID for pet gear bags")
RULE_BOOL(Pets, PetGearBagScanBank, false, "Scan bank for pet gear bags")
RULE_INT(Pets, PetGearBagRescanSeconds, 5, "Seconds between rescanning pet gear")
RULE_BOOL(Pets, PetGearBagVirtualEquip, true, "Apply stats from pet gear")
...
RULE_BOOL(Custom, MulticlassingEnabled, false, "Enable multiclass-specific gameplay features and packets.")
RULE_CATEGORY_END()
